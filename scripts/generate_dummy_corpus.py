    ...
    docs = [
        {
            ...
            "claims": ["1. A battery comprising quantum entangled cells.", "2. The battery of claim 1, further comprising a supercooled containment unit."],
            "cpc_codes": ["H01M"],
        ...
        },
        {
            ...
            "claims": ["1. An anode comprising silicon and graphene layers.", "2. A device comprising the anode and a solid-state electrolyte."],
            "cpc_codes": ["H01M"],
        ...
        },
        {
            ...
            "claims": ["1. A processor device comprising a memory array of ReRAM cells.", "2. The processor wherein the memory is tightly coupled to the compute cores."],
            "cpc_codes": ["G06F", "H01L"],
