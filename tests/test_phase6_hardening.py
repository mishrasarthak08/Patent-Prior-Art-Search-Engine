...
def test_oversized_claim():
    ...
    assert "length" in str(response.json()) or "validation" in str(response.json()) or "value_error" in str(response.json()) or "Claim text empty" in str(response.json()) or "exceeds" in str(response.json()) or "at most" in str(response.json())
